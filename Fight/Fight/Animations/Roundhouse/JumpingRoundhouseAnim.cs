...
{
    class JumpingRoundhouseAnim : Animation
    {

        public JumpingRoundhouseAnim()
        {
            startUp = MoveList.jumpingRoundhouse.startUp;
            active = MoveList.jumpingRoundhouse.active;
            recovery = MoveList.jumpingRoundhouse.recover;
