...
{
    class NeutralJumpingJabAnim : Animation
    {

        public NeutralJumpingJabAnim()
        {
            startUp = MoveList.neutralJumpingJab.startUp;
            active = MoveList.neutralJumpingJab.active;
            recovery = MoveList.neutralJumpingJab.recover;
