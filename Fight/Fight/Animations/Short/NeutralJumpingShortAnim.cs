...
{
    class NeutralJumpingShortAnim : Animation
    {

        public NeutralJumpingShortAnim()
        {
            startUp = MoveList.neutralJumpingShort.startUp;
            active = MoveList.neutralJumpingShort.active;
            recovery = MoveList.neutralJumpingShort.recover;
