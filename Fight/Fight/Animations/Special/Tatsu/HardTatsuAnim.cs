...
{
    class HardTatsuAnim : Animation
    {
        public HardTatsuAnim()
        {
            startUp = MoveList.hardTatsu.startUp;
            active = MoveList.hardTatsu.active;
            recovery = MoveList.hardTatsu.recover;
            ...
            for (int i = 0; i < active; i++)
            {
                ...
                else if (i < 2 * active / 12)
                    animations[i + startUp] = new Rectangle(1112, 489, 48, 124);
                else if (i < 3 * active / 12)
                    animations[i + startUp] = new Rectangle(1162, 489, 68, 124);
                else if (i < 4 * active / 12)
                    animations[i + startUp] = new Rectangle(1232, 489, 45, 125);
                else if (i < 5 * active / 12)
                    animations[i + startUp] = new Rectangle(1043, 490, 66, 124);
                else if (i < 6 * active / 12)
                    animations[i + startUp] = new Rectangle(1112, 489, 48, 124);
                else if (i < 7 * active / 12)
                    animations[i + startUp] = new Rectangle(1162, 489, 68, 124);
                else if (i < 8 * active / 12)
                    animations[i + startUp] = new Rectangle(1232, 489, 45, 125);
                else if (i < 9 * active / 12)
                    animations[i + startUp] = new Rectangle(1043, 490, 66, 124);
                else if (i < 10 * active / 12)
                    animations[i + startUp] = new Rectangle(1112, 489, 48, 124);
                else if (i < 11 * active / 12)
                    animations[i + startUp] = new Rectangle(1162, 489, 68, 124);
                else
                    animations[i + startUp] = new Rectangle(1232, 489, 45, 125);
            }
            ...
            for (int i = 0; i < startUp + active + recovery; i++)
                displacement[i] = MoveList.mediumTatsu.displacement;
