...
{
    class MediumTatsuAnim : Animation
    {
        public MediumTatsuAnim()
        {
            startUp = MoveList.mediumTatsu.startUp;
            active = MoveList.mediumTatsu.active;
            recovery = MoveList.mediumTatsu.recover;
