...
{
    class HardShoryuAnim : Animation
    {
        public HardShoryuAnim()
        {
            startUp = MoveList.hardShoryu.startUp;
            active = MoveList.hardShoryu.active;
            recovery = MoveList.hardShoryu.recover;
            ...
            displacement[5].Y = MoveList.hardShoryu.displacement.Y;
