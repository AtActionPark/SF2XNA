...
{
    class LightShoryuAnim : Animation
    {
        public LightShoryuAnim()
        {
            startUp = MoveList.lightShoryu.startUp;
            active = MoveList.lightShoryu.active;
            recovery = MoveList.lightShoryu.recover;
            ...
            displacement[5] = MoveList.lightShoryu.displacement;
