...
{
    class StandingFierceAnim : Animation
    {

        public StandingFierceAnim()
        {
            startUp = MoveList.standingFierce.startUp;
            active = MoveList.standingFierce.active;
            recovery = MoveList.standingFierce.recover;
