...
{
    class JumpingFierceAnim : Animation
    {

        public JumpingFierceAnim()
        {
            startUp = MoveList.jumpingFierce.startUp;
            active = MoveList.jumpingFierce.active;
            recovery = MoveList.jumpingFierce.recover;
