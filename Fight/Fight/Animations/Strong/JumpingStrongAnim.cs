...
{
    class JumpingStrongAnim : Animation
    {

        public JumpingStrongAnim()
        {
            startUp = MoveList.jumpingStrong.startUp;
            active = MoveList.jumpingStrong.active;
            recovery = MoveList.jumpingStrong.recover;
