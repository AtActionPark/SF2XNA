...
{
    class NeutralJumpingStrongAnim : Animation
    {

        public NeutralJumpingStrongAnim()
        {
            startUp = MoveList.neutralJumpingStrong.startUp;
            active = MoveList.neutralJumpingStrong.active;
            recovery = MoveList.neutralJumpingStrong.recover;
