...
{
    class NeutralJumpingForwardAnim : Animation
    {

        public NeutralJumpingForwardAnim()
        {
            startUp = MoveList.neutralJumpingForward.startUp;
            active = MoveList.neutralJumpingForward.active;
            recovery = MoveList.neutralJumpingForward.recover;
