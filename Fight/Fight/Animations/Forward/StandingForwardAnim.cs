...
{
    class StandingForwardAnim : Animation
    {

        public StandingForwardAnim()
        {
            startUp = MoveList.standingForward.startUp;
            active = MoveList.standingForward.active;
            recovery = MoveList.standingForward.recover;
